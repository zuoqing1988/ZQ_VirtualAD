#ifndef _ZQ_PLAY_TRACKING_GUI_H_
#define _ZQ_PLAY_TRACKING_GUI_H_
#pragma once

#include "ZQ_PlayTrackingConfig.h"
#include <vector>
#include "ZQ_Vec2D.h"
...
namespace ZQ
{
	...
	private:
		...
		static ZQ_PlayTrackingConfig config;
