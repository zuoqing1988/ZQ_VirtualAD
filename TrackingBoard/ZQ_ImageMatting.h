#ifndef _ZQ_IMAGE_MATTING_H_
#define _ZQ_IMAGE_MATTING_H_
#pragma once 
...
#include "ZQ_VirtualAdvertisementRender.h"

namespace ZQ
{
	class ZQ_ImageMatting
	{
	...
	private:
		...
		static ZQ_VirtualAdvertisementRender::MarkerMode marker_mode;
