...
const char* ZQ_SelectPolygon::winName = "Select Polygon @ Zuo Qing";
float ZQ_SelectPolygon::coord_x[ZQ_SelectPolygon::MAX_NUM_PTS] = { 0 };
float ZQ_SelectPolygon::coord_y[ZQ_SelectPolygon::MAX_NUM_PTS] = { 0 };
int ZQ_SelectPolygon::max_num_pts = ZQ_SelectPolygon::MAX_NUM_PTS;
int ZQ_SelectPolygon::cur_coord_num = 0;
float ZQ_SelectPolygon::scale = 1.0;
IplImage* ZQ_SelectPolygon::background_img = 0;
IplImage* ZQ_SelectPolygon::zoom_background_img = 0;
IplImage* ZQ_SelectPolygon::draw_img = 0;
int ZQ_SelectPolygon::zoom_scale = 5;
bool ZQ_SelectPolygon::zoom_mode = false;
int ZQ_SelectPolygon::zoom_center_x = 0;
int ZQ_SelectPolygon::zoom_center_y = 0;
int ZQ_SelectPolygon::cur_mouse_pos_x = 0;
int ZQ_SelectPolygon::cur_mouse_pos_y = 0;
bool ZQ_SelectPolygon::updated_flag = false;

bool ZQ_SelectPolygon::Select(const IplImage* img, std::vector<ZQ::ZQ_Vec2D>& poly, int max_npts, float show_scale, const char* win_name)
{
	if (img == 0)
		return false;
	poly.clear();
...
void ZQ_SelectPolygon::_mouseHandler(int event, int x, int y, int flags, void* param)
{
	cur_mouse_pos_x = x;
	cur_mouse_pos_y = y;
...
void ZQ_SelectPolygon::_drawPolygon(IplImage* img)
{
